@extends('layouts.app')<?php //el header?>
@section('content')
<br>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" aria-label="Configuracion de mi cuenta"><?php //enctype="multipart/form-data" esto es porqe van a pasar imagenes ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ Auth::user()->name }}" required autofocus><?php //Auth::user()->name con esto ya tengo el dato gracias a laravel Auth::porqe es estatic y user es el metodo q tiene los datos ,la clase el metodo lo hizo laravel ?>
